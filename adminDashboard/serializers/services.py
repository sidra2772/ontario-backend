...
class AdminServicesSerializer(serializers.ModelSerializer):
    ...
    supplier_image = serializers.CharField(source='supplier.image', read_only=True)
    ...
    class Meta:
        model = Services
        fields = '__all__'
        read_only_fields = ['id', 'service_slug', 'created_at', 'updated_at']
